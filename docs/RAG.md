...
│  ┌─────────────────────────────────────────────────────────────────────┐    │
│  │                       ContextScorer                                  │    │
│  │  FINAL = (token × 0.4) + (doc × 0.3) + (semantic × 0.3)             │    │
│  └─────────────────────────────────────────────────────────────────────┘    │
│                              │                                               │
│                              ▼                                               │
│                  ┌───────────────────────┐                                  │
...
|--------|--------|----------|----------|------|
| **Token Overlap** | 0.4 | 키워드 직접 일치 | 동일 단어만 | "데이터" = "데이터" ✅ |
| **Doc Reference** | 0.3 | 문서별 키워드 포함 여부 | 동일 단어만 | 3개 중 2개 문서 참조 |
| **Semantic Similarity** | 0.3 | 코사인 유사도 (임베딩) | 동의어/유사 개념 | "ML" ≈ "머신러닝" ✅ |

### 1. Token Overlap (가중치 0.4)
